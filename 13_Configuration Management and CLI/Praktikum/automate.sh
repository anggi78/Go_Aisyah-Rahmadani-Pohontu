...
echo "Facebook: https://www.facebook.com/aisyahfb" > "$main_dir/about_me/personal/facebook.txt"
echo "LinkedIn: https://www.linkedin.com/in/aisyahrahmadanipohontulinkedin" > "$main_dir/about_me/professional/linkedin.txt"
